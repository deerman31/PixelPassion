        ...
        <div className="max-w-md mx-auto bg-white rounded-lg shadow p-8">
          ...
          <Form.Root onSubmit={handleGpsSubmit} className="space-y-4">
            <CheckboxField
              ...
              checked={gpsFormData.isGpsEnabled}
          ...
          <Form.Root onSubmit={handleGenderSubmit} className="space-y-4">
            <RadioGroupField
              ...
              onChange={(value) => handleGenderRadioChange("gender", value)}
          ...
          <Form.Root onSubmit={handleSexualSubmit} className="space-y-4">
            <RadioGroupField
              ...
              value={sexualFormData.sexual_orientation}
              options={ORIENTATION_OPTIONS}
              onChange={(value) =>
                handleSexualRadioChange("sexual_orientation", value)}
          ...
          <Form.Root onSubmit={handleEriaSubmit} className="space-y-4">
            <SelectField
              ...
              options={PREFECTURES}
              onChange={(value) =>
                setEriaFormData({ ...eriaFormData, eria: value })}
